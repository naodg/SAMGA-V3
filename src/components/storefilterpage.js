...
export default function StoreFilterPage() {
    ...
    return (_jsxs("div", { children: [isMobile ? (_jsxs(_Fragment, { children: [_jsx("div", { className: "mobile-search-wrapper", children: _jsxs("div", { className: "mobile-search-bar", children: [_jsx("button", { className: "mobile-search-icon-button", onClick: () => {
                                    ...
                                    }, children: _jsx("img", { src: "/SAMGA-V3/img/logo/search.svg", alt: "\uAC80\uC0C9 \uC544\uC774\uCF58" }) }), _jsx("input", { type: "text", value: searchQuery, className: "search-input", placeholder: "\uB0B4\uAC00 \uCC3E\uB294 \uC2DD\uB2F9\uC744 \uAC80\uC0C9\uD574\uBCF4\uC138\uC694.", onFocus: () => setShowMap(true), onChange: (e) => {
                                ...
                                return (_jsxs("div", { className: "mobile-store-item", onClick: () => navigate(`/store/${encodeURIComponent(store.name)}`), children: [_jsxs("div", { className: "store-item-header", children: [_jsx("img", { src: store.filterimage || '/SAMGA-V3/img/default.jpg', alt: store.name, className: "m-store-thumbnail" }), _jsxs("div", { className: "store-info-text", children: [_jsx("h3", { className: "store-name", children: store.name }), _jsxs("div", { className: "rating-review", children: [_jsxs("div", { className: "store-stars", children: [[...Array(5)].map((_, i) => {
                            ...
                            }), selectedStore && !triggeredFromReservation && (_jsxs("div", { className: "popup-store-card", children: [_jsxs("div", { className: "card-header", children: [_jsx("h3", { className: "store-name", children: selectedStore.name }), _jsx("button", { onClick: () => setSelectedStore(null), className: "close-button", children: "\u2716" })] }), _jsx("p", { className: "store-address", children: selectedStore.address }), _jsx("p", { className: "store-phone", children: selectedStore.phone }), _jsx("a", { href: `https://map.kakao.com/link/to/${selectedStore.name},${selectedStore.lat},${selectedStore.lng}`, target: "_blank", rel: "noopener noreferrer", className: "filter-map-link", children: "\uAE38\uCC3E\uAE30" })] }))] })] })) : (_jsx(_Fragment, { children: _jsxs("div", { className: "pc-wrapper", children: [_jsx("div", { className: "pc-search-wrapper", children: _jsxs("div", { className: "pc-search-bar", children: [_jsx("button", { className: "search-icon-button-fillter", onClick: () => {
                                            if (searchQuery.trim() === '') {
                                                setFilteredStores(storeData);
                                                setSelectedStore(null);
                                            }
                                        ...
                                        }, children: _jsx("img", { src: "/SAMGA-V3/img/logo/search.svg", alt: "\uAC80\uC0C9 \uC544\uC774\uCF58" }) }), _jsx("input", { type: "text", value: searchQuery, placeholder: "\uB0B4\uAC00 \uCC3E\uB294 \uC2DD\uB2F9\uC744 \uAC80\uC0C9\uD574\uBCF4\uC138\uC694.", className: "search-input", onFocus: () => setShowMap(true), onChange: (e) => {
                                            const keyword = e.target.value;
                                            setSearchQuery(keyword);
                                            if (keyword.trim() === '') {
                                                setFilteredStores(storeData);
