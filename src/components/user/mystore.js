...
export default function MyStore() {
    ...
    return (_jsxs("div", { className: "mystore-container", children: [_jsx("h2", { children: "\uD83D\uDCCC \uB0B4\uAC00 \uB2E8\uACE8 \uB4F1\uB85D\uD55C \uAC00\uAC8C" }), loading ? (_jsx("p", { children: "\uB85C\uB529 \uC911..." })) : favoriteStores.length === 0 ? (_jsx("p", { children: "\uB2E8\uACE8 \uB4F1\uB85D\uD55C \uAC00\uAC8C\uAC00 \uC5C6\uC2B5\uB2C8\uB2E4." })) : (_jsx("div", { className: "store-list", children: favoriteStores.map((store, index) => (_jsxs("div", { className: "store-card", onClick: () => store.name && navigate(`/store/${encodeURIComponent(store.name)}`), children: [_jsx("img", { src: store.filterimage || "/default.jpg", alt: store.name || "가게 이미지" }), _jsx("div", { className: "store-name", children: store.name }), _jsx("div", { className: "store-address", children: store.address })] }, store.name || index))) }))] }));
}
