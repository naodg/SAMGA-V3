    ...
    useEffect(() => {
        const handleClickOutside = (e) => {
            if (storeRef.current?.contains(e.target) ||
                tourRef.current?.contains(e.target) ||
