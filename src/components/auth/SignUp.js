...
export default function SignUp() {
    ...
    const isFormValid = agree &&
        ...
        phone.trim().length > 0;
    return (_jsxs("div", { className: "signup-page", children: [_jsxs("div", { className: "signup-wrapper", children: [_jsx("div", { className: "auth-image" }), _jsx("div", { className: "signup-text", children: "\uD68C\uC6D0\uAC00\uC785" }), _jsxs("form", { onSubmit: handleSignUp, children: [_jsx("input", { className: "signup-input", type: "text", placeholder: "\uBCF8\uC778 \uC774\uB984", value: nickname, onChange: (e) => setNickname(e.target.value), required: true }), _jsx("br", {}), _jsx("input", { className: "signup-input", type: "email", placeholder: "\uC774\uBA54\uC77C", value: email, onChange: (e) => setEmail(e.target.value), required: true }), _jsx("br", {}), _jsx("input", { className: "signup-input", type: "password", placeholder: "\uBE44\uBC00\uBC88\uD638", value: password, onChange: (e) => setPassword(e.target.value), required: true }), _jsx("br", {}), _jsx("input", { className: "signup-input", type: "text", placeholder: "\uC804\uD654\uBC88\uD638 - \uC81C\uC678\uD6C4 \uC785\uB825\uD574\uC8FC\uC138\uC694", value: phone, onChange: (e) => {
                                    const formatted = formatPhoneNumber(e.target.value);
                                    setPhone(formatted);
                                    validatePhone(formatted);
                                }, required: true }), _jsx("br", {}), phoneError && _jsx("p", { style: { color: "red" }, children: phoneError }), _jsxs("div", { className: "agreement-row", style: { display: "flex", alignItems: "center", gap: "8px", margin: "8px 0 16px" }, children: [_jsx("input", { id: "agree", type: "checkbox", checked: agree, onChange: (e) => setAgree(e.target.checked) }), _jsx("label", { htmlFor: "agree", style: { userSelect: "none", fontSize: 14, color: "#000" }, children: "\uAC1C\uC778\uC815\uBCF4 \uC218\uC9D1 \uBC0F \uC774\uC6A9\uC5D0 \uB3D9\uC758\uD569\uB2C8\uB2E4." }), _jsx("button", { type: "button", className: "link-like-button", onClick: () => setShowPolicyModal(true), "aria-haspopup": "dialog", "aria-controls": "policy-modal", children: "\uC0C1\uC138\uBCF4\uAE30" })] }), _jsx("button", { type: "submit", className: "Buttons", disabled: !isFormValid, children: "\uD68C\uC6D0\uAC00\uC785" })] }), error && _jsx("p", { style: { color: "red" }, children: error }), success && _jsx("p", { style: { color: "green" }, children: success })] }), showPolicyModal && (_jsx("div", { id: "policy-modal", role: "dialog", "aria-modal": "true", "aria-labelledby": "policy-modal-title", className: "modal-overlay", onClick: () => setShowPolicyModal(false), style: {
                    position: "fixed",
                    inset: 0,
                    ...
                    padding: "16px",
                    zIndex: 1000
                }, children: _jsxs("div", { className: "modal-content", onClick: (e) => e.stopPropagation(), style: {
                        background: "#fff",
                        width: "100%",
                        maxWidth: "720px",
                        maxHeight: "80vh",
                        ...
                        borderRadius: "12px",
                        padding: "24px"
                    }, children: [_jsx("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }, children: _jsx("h3", { id: "policy-modal-title", style: { margin: 0 }, children: "\uAC1C\uC778\uC815\uBCF4 \uC218\uC9D1 \uBC0F \uC774\uC6A9 \uB3D9\uC758" }) }), _jsx("div", { style: { whiteSpace: "pre-wrap", lineHeight: 1.6, fontSize: "14px" }, children: `
...
전자상거래 소송에는 대한민국 법을 적용합니다.` }), _jsx("div", { style: { marginTop: "16px", display: "flex", justifyContent: "flex-end", gap: "8px" }, children: _jsx("button", { type: "button", onClick: () => setShowPolicyModal(false), children: "\uB2EB\uAE30" }) })] }) }))] }));
}
