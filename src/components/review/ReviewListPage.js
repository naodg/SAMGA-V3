...
export default function ReviewListPage() {
    ...
    return (_jsxs("div", { className: "review-list-page", children: [_jsxs("div", { className: "review-list-header", children: [_jsx("h2", { className: "review-title", children: "\uB9AC\uBDF0 \uBAA9\uB85D" }), _jsxs("select", { value: selectedStoreId, onChange: (e) => setSelectedStoreId(e.target.value), className: "store-filter-dropdown", children: [_jsx("option", { value: "all", children: "\uC804\uCCB4 \uBCF4\uAE30" }), storeData.map((store, i) => (_jsx("option", { value: store.name, children: store.name }, i)))] })] }), reviews.length === 0 && _jsx("p", { className: "no-review", children: "\uC791\uC131\uB41C \uB9AC\uBDF0\uAC00 \uC544\uC9C1 \uC5C6\uC5B4\uC694!" }), _jsx("div", { className: "review-list-grid", children: reviews.map((review) => {
                    ...
                    return (_jsx("div", { className: "review-card", onClick: () => navigate(`/review/${review.id}`), style: { cursor: "pointer", position: "relative" }, children: store && (_jsxs(_Fragment, { children: [_jsx("div", { className: "store-badge", children: _jsx("img", { src: `/SAMGA-V2/img/review_icons/${store.name}.jpg`, className: "store-badge-icon", alt: store.name }) }), _jsxs("div", { className: "review-main", children: [_jsxs("div", { className: "review-header", children: [_jsx("h3", { className: "store-name", children: store.name }), _jsxs("div", { className: "review-stars", children: [[...Array(5)].map((_, i) => {
                                                            const value = i + 1;
                                                            ...
                                                            return _jsx("img", { src: src, className: "star-icon", alt: "\uBCC4" }, i);
                                                                ...
                                                                : "/SAMGA-V2/img/icon/댓글.svg", alt: "\uB313\uAE00" }), _jsx("span", { children: commentsMap[review.id]?.length })] }), _jsxs("div", { className: "review-meta", children: [_jsxs("span", { className: "review-nickname", children: ["\uC791\uC131\uC790: ", review.nickname] }), _jsx("br", {}), _jsx("span", { className: "review-date", children: review.createdAt?.toDate().toLocaleString() || "날짜 없음" })] })] })] })] })) }, review.id));
                }) }), !isEnd && (_jsx("button", { className: "load-more-button", onClick: () => fetchReviews(), children: "\uB354\uBCF4\uAE30" })), _jsx("button", { className: "write-review-fixed", onClick: () => navigate("/write"), children: "\uB9AC\uBDF0 \uC4F0\uAE30" }), _jsx("button", { className: "reservation", onClick: () => navigate("/write"), children: "\uC608\uC57D \uC2E0\uCCAD" })] }));
}
