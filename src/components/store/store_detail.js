    ...
    return (_jsxs("div", { className: "store-detail-wrapper", children: [_jsx("div", { className: "store-hero-image", style: {
                    ...
                    _jsx("div", { className: "store-review-list", children: storeReviews.map((review, idx) => {
                            ...
                            return (_jsxs("div", { className: "store-review-card", children: [_jsx("div", { className: "review-content", children: _jsx("p", { children: review.content }) }), _jsx("div", { className: "review-header", children: _jsxs("div", { className: "review-stars", children: [[...Array(5)].map((_, i) => {
                                                ...
                                                }), _jsxs("span", { className: "review-star-value", children: [(review.star ?? 0).toFixed(1), "\uC810"] })] }) }), _jsxs("div", { className: "review-footer", children: [_jsxs("div", { className: "review-icons", children: [_jsx("img", { src: "/img/icon/\uC88B\uC544\uC6A9.svg", alt: "\uC88B\uC544\uC694" }), _jsx("span", { children: likeCount }), _jsx("img", { src: comments.length > 0
                                                            ? "/img/icon/댓글있음.svg"
                                                            : "/img/icon/댓글.svg", alt: "\uB313\uAE00" }), _jsx("span", { children: comments.length })] }), _jsxs("div", { className: "review-meta", children: [_jsxs("span", { className: "review-nickname", children: ["\uC791\uC131\uC790: ", review.nickname.length <= 2
                                                                ? review.nickname[0] + '*'
                                                                : review.nickname[0] + '*'.repeat(review.nickname.length - 2) + review.nickname.slice(-1)] }), _jsx("span", { className: "review-date", children: review.createdAt?.toDate().toLocaleString() })] })] })] }, idx));
                        }) })) : (
