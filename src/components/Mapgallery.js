...
export default function MapGallery() {
    ...
    return (_jsxs("div", { className: "map-gallery-wrapper", children: [_jsxs("div", { className: "map-gallery-inner", children: [_jsx("div", { className: "map-gallery-swiper-container", children: _jsx(Swiper, { className: "map-gallery-swiper", modules: [Navigation, Pagination, Autoplay], navigation: true, pagination: { clickable: true }, autoplay: { delay: 2000, disableOnInteraction: false, }, loop: true, grabCursor: true, simulateTouch: true, touchRatio: 1, allowTouchMove: true, children: shuffledNames.map((name, i) => (_jsx(SwiperSlide, { children: _jsx("img", { src: `/img/landing/${name}_1.jpg`, alt: name, className: "map-gallery-slide-img", draggable: false }) }, i))) }) }), _jsxs("div", { className: "map-gallery-floating-box", children: [_jsxs("div", { className: "map-gallery-searchbar", children: [_jsx("button", { className: "search-icon-button", onClick: () => {
                                        ...
                                        } })] }), showMap && (_jsxs("div", { className: "map-gallery-map-container", children: [isMobile ? (_jsx("div", { id: "map", ref: mapContainerRef })) : (_jsx("div", {})), selectedStore && (() => {
                                        ...
                                        return (_jsxs("div", { className: "map-gallery-info-card", children: [_jsx("div", { className: "info-header", children: _jsxs("h3", { className: "store-name", children: [selectedStore.name, _jsxs("span", { className: "rating", children: [[...Array(5)].map((_, i) => {
                                                                        const value = i + 1;
                                                                        let imgSrc = "";
                                                                    ...
                                                                    }), _jsxs("span", { className: "review-score", children: [rating?.average?.toFixed(1) || "0.0", "\uC810"] }), _jsxs("span", { className: "review-count", children: ["(", rating?.count || 0, "\uAC1C \uB9AC\uBDF0)"] })] })] }) }), _jsx("div", { className: "store-detail", children: _jsxs("div", { className: "store-address", children: [_jsx("span", { className: "label", children: "\uC8FC\uC18C :" }), " ", selectedStore.address, _jsx("a", { href: `https://map.kakao.com/link/to/${selectedStore.name},${selectedStore.lat},${selectedStore.lng}`, target: "_blank", rel: "noopener noreferrer", className: "map-link", children: "\uAE38\uCC3E\uAE30" })] }) }), _jsx("div", { className: 'store-detail', children: _jsxs("span", { className: "phone-text", children: ["\uC804\uD654\uBC88\uD638 : ", selectedStore.phone, _jsx("a", { href: `tel:${selectedStore.phone.replace(/[^0-9]/g, '')}`, className: "call-icon", "aria-label": "\uC804\uD654 \uAC78\uAE30", children: _jsx("img", { src: "/img/icon/call.svg", alt: "\uC804\uD654 \uC544\uC774\uCF58" }) })] }) }), _jsx("p", { className: "store-detail", children: _jsxs("span", { className: "label", children: ["\uC601\uC5C5\uC2DC\uAC04 : ", selectedStore.hours.split('/')[0], selectedStore.point && (_jsxs("span", { className: "point", children: [" \u203B ", selectedStore.point] }))] }) }), _jsx("p", { className: "store-detail", children: _jsxs("span", { className: "label", children: ["\uD734\uBB34 : ", selectedStore.hours.split('/')[1].replace('휴무', '')] }) }), _jsxs("div", { className: "menu-links", children: [_jsx("div", { className: "link", onClick: () => navigate("/review"), style: { fontWeight: 'bold', color: '#333' }, children: "Review" }), _jsx("span", { className: "divider", children: "|" }), _jsx("div", { className: "link", onClick: () => navigate(`/store/${encodeURIComponent(selectedStore.name)}`), style: { fontWeight: 'bold', color: '#333' }, children: "\uC0C1\uC138\uD398\uC774\uC9C0 \uBC14\uB85C\uAC00\uAE30" })] })] }));
                                    })(), isMobile ? (_jsx("div", {})) : (_jsx("div", { id: "map", ref: mapContainerRef }))] }))] })] }), _jsx("div", { className: "map-gallery-pattern" })] }));
}
