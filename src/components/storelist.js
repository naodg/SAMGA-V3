...
export default function StoreList() {
    ...
    return (_jsxs("div", { className: "storelist-landing", children: [_jsxs("div", { className: "landing-video-wrapper", children: [_jsx("img", { src: "/SAMGA-V3/img/logo/videologo.svg", alt: "\uC0BC\uAC00\uD55C\uC6B0\uB85C\uACE0", className: "landing-logo" }), _jsx("iframe", { className: "video", src: "https://drive.google.com/file/d/1WF-K2Nu6Jer87imLhWAyKXeWraxIkvVP/preview", width: "92%", height: "400px", frameBorder: "0", style: { borderRadius: '12px', padding: '110px 0 0' }, allow: "autoplay; encrypted-media", allowFullScreen: true })] }), _jsxs("div", { className: "landing-text", children: [_jsx("img", { src: "/SAMGA-V3/img/logo/tasty.svg", alt: "tasty", className: "tasty" }), _jsxs("h2", { className: "landing-title", children: ["\uC0BC\uAC00\uC5D0\uC120 \uD55C\uC6B0\uAC00 \uC77C\uC0C1,", _jsx("br", {}), "\uB9E4\uC77C \uD2B9\uBCC4\uD55C \uACE0\uAE30 \uD55C \uB07C"] }), _jsx("hr", { className: "landing-divider" }), _jsx("p", { className: "landing-tagline", children: "KOREAN BEEF VILLAGE SAMGA" })] }), _jsxs("div", { className: "store-card-grid", children: [shuffledStores.map((store, index) => {
                        ...
                        return (_jsxs("div", { className: "store-card-wrapper", children: [_jsxs("h3", { className: "store-title", style: {
                                    ...
                                    gap: '8px' // 텍스트랑 아이콘 사이 여백
                                            ...
                                            height: '18px',
                                            objectFit: 'contain'
                                        } }), "\u725B\uB9AC\uB9C8\uC744"] }), _jsx("div", { className: "store-card", children: _jsx("img", { src: "/SAMGA-V3/samga/store/소탈이.jpg", alt: "소탈이", className: "store-card-image" }) })] })] }), _jsxs("div", { className: "banner-wrapper", children: [_jsxs("div", { className: "banner-title-area", children: [_jsx("img", { src: "/SAMGA-V3/img/logo/bannerlogo.svg", alt: "\uD0C0\uC774\uD2C0\uB85C\uACE0", className: "slogan-img" }), _jsxs("div", { className: "banner-subtitle", children: [_jsx("span", { className: "bolder", children: "\uB9DB!" }), "\uC788\uB294", _jsx("span", { className: "bolder", children: "\uBA4B!" }), "\uC788\uB294 \uC88B\uC740", _jsx("span", { className: "bolder", children: "\uC0AC\uB78C" }), "\uACFC"] }), _jsx("div", { className: "banner-title", children: "\uAC00\uBCFC\uB9CC\uD55C \uACF3?" })] }), _jsx(Swiper, { modules: [Navigation, Autoplay], pagination: { clickable: false }, autoplay: { delay: 2000 }, loop: true, spaceBetween: 20, slidesPerView: 4, breakpoints: {
                            0: {
