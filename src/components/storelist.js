...
export default function StoreList() {
    ...
    return (_jsxs("div", { className: "storelist-landing", children: [_jsxs("div", { className: "landing-video-wrapper", children: [_jsx("img", { src: "/img/logo/videologo.svg", alt: "\uC0BC\uAC00\uD55C\uC6B0\uB85C\uACE0", className: "landing-logo" }), _jsx("iframe", { className: "video", src: "https://drive.google.com/file/d/1WF-K2Nu6Jer87imLhWAyKXeWraxIkvVP/preview", width: "92%", height: "400px", frameBorder: "0", allow: "autoplay; encrypted-media", allowFullScreen: true })] }), _jsxs("div", { className: "landing-text", children: [_jsx("img", { src: "/img/logo/tasty.svg", alt: "tasty", className: "tasty" }), _jsxs("h2", { className: "landing-title", children: ["\uC0BC\uAC00\uC5D0\uC120 \uD55C\uC6B0\uAC00 \uC77C\uC0C1,", _jsx("br", {}), "\uB9E4\uC77C \uD2B9\uBCC4\uD55C \uACE0\uAE30 \uD55C \uB07C"] }), _jsx("hr", { className: "landing-divider" }), _jsx("p", { className: "landing-tagline", children: "KOREAN BEEF VILLAGE SAMGA" })] }), _jsx("div", { style: {
                    position: "absolute",
                    left: "-9999px",
                    width: "1px",
                    height: "1px",
                    overflow: "hidden",
                }, children: "\uD55C\uC6B0, \uC6B0\uB9AC\uB9C8\uC744 \uC0BC\uAC00, \uC0BC\uAC00\uD55C\uC6B0, \uD569\uCC9C \uC0BC\uAC00, \uC18C\uACE0\uAE30, \uD569\uCC9C \uC18C\uACE0\uAE30, \uBE44\uD504\uC18C\uBBC8\uB9AC\uC5D0, \uD569\uCC9C \uD55C\uC6B0, \uC0BC\uAC00, \uD569\uCC9C, \uB9C8\uC744 \uC0BC\uAC00" }), _jsxs("div", { className: "store-card-grid", children: [shuffledStores.map((store, index) => {
