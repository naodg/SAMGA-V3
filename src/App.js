...
function AppContent() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Header, {}), _jsx(ScrollToTop, {}), _jsxs(Routes, { children: [_jsx(Route, { path: "/signup", element: _jsx(SignUp, {}) }), _jsx(Route, { path: "/login", element: _jsx(SignIn, {}) }), _jsx(Route, { path: '/privacy', element: _jsx(PrivacyPolicy, {}) }), _jsx(Route, { path: "/mypage", element: _jsxs(_Fragment, { children: [_jsx(AutoLogoutTimer, {}), _jsx(Mypage, {})] }) }), _jsx(Route, { path: '/mypage/mystore', element: _jsx(MyStore, {}) }), _jsx(Route, { path: '/myreview', element: _jsx(MyReview, {}) }), _jsx(Route, { path: '/myinfo', element: _jsx(Myinfo, {}) }), _jsx(Route, { path: '/vilage', element: _jsx(VilageInfo, {}) }), _jsx(Route, { path: '/mascot', element: _jsx(Sotal, {}) }), _jsx(Route, { path: "/goods", element: _jsx(Goodsmall, {}) }), _jsx(Route, { path: "/goods/:id", element: _jsx(GoodsmallDetail, {}) }), _jsx(Route, { path: "/", element: _jsx(Mainthing, {}) }), _jsx(Route, { path: "/store/:name", element: _jsx(StoreDetail, {}) }), _jsx(Route, { path: "/storefilterpage", element: _jsx(StoreFilterPage, {}) }), _jsx(Route, { path: "/review", element: _jsx(ReviewListPage, {}) }), _jsx(Route, { path: "/write", element: _jsx(ReviewWritePage, {}) }), _jsx(Route, { path: "/review/:id", element: _jsx(ReviewDetailPage, {}) }), _jsx(Route, { path: "/admin/:storeId", element: _jsx(AdminDashboard, {}) }), _jsx(Route, { path: "/uploader/:storeId", element: _jsx(AdminImageUploader, {}) })] }), !shouldHideFloating && _jsx(Floating, {}), _jsx(Footer, {})] }));
}
function App() {
